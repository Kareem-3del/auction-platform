    ...
    <StyledCard onClick={onClick}>
      <ImageContainer>
        ...
        <ProductImage
          ...
          alt={product.title}
          onError={(e) => {
            e.currentTarget.src = 'data:image/svg+xml;base64,';
          }}
        />
