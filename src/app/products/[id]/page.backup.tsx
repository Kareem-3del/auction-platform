  ...
  return (
    <Box sx={{ backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
      <Box maxWidth="1400px" mx="auto" px={3} py={2}>
        ...
        {/* TOP SECTION - AUCTION INFORMATION */}
        <Box sx={{ mb: 4 }}>
          ...
          <Grid container spacing={3} sx={{ mb: 3 }}>
            ...
            <Grid item xs={12} md={4}>
              <Card sx={{ 
                ...
                borderRadius: 3,
                boxShadow: '0 8px 24px rgba(206, 14, 45, 0.15)',
                height: '100%',
                display: 'flex',
                flexDirection: 'column',
                justifyContent: 'center'
              }}>
                <Typography variant="h6" sx={{ color: '#CE0E2D', fontWeight: 'bold', mb: 1 }}>
                  CURRENT BID
                </Typography>
                <Typography 
                  variant="h3" 
        ...
        {/* MIDDLE SECTION - CENTERED PRODUCT IMAGE */}
        ...
        {/* BOTTOM SECTION - PRODUCT DETAILS & ADDITIONAL INFO */}
        <Grid container spacing={4} sx={{ mt: 2 }}>
          ...
          <Grid item xs={12} md={6}>
            <Card sx={{ 
              ...
              <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#0F1419', mb: 2 }}>
                📍 Item Information
              </Typography>
              
              <Box display="flex" alignItems="center" mb={2}>
                <LocationIcon sx={{ fontSize: 20, mr: 1, color: '#CE0E2D' }} />
